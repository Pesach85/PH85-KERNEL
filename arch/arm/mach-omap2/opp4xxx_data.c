...
#define OMAP4430_VDD_MPU_OPP25_UV		 850000
#define OMAP4430_VDD_MPU_OPP50_UV		 925000
#define OMAP4430_VDD_MPU_OPP100_UV		1025000
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1105000
#define OMAP4430_VDD_MPU_OPPTURBO_UV2		1145000
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1175000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1285000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV2		1325000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO_UV2, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfb, 0x25, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfc, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfd, 0x2b, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV2, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfd, 0x2b, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};

#define OMAP4430_VDD_IVA_OPP50_UV		 950000
#define OMAP4430_VDD_IVA_OPP100_UV		1114000
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1251000
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_OV_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xfe, 0x1f, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0 , 0),
};
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPTURBO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPTURBO_UV2, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 800000000, OMAP4430_VDD_MPU_OPPTURBO_UV),
        /* MPU OPP4 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 900000000, OMAP4430_VDD_MPU_OPPTURBO_UV2),
	/* MPU OPP5 - OPP-NT */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
	/* MPU OPP6 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1208000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
        /* MPU OPP6 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1260000000, OMAP4430_VDD_MPU_OPPNITROSB_UV2),
	/* L3 OPP1 - OPP50 */
...
int __init omap4_opp_init(void)
{
	...
	if (omap4_has_mpu_1ghz())
                ...
                omap4_opp_enable("mpu", 1260000000);        
