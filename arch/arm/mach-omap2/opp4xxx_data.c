...
<<<<<<< HEAD
#define OMAP4430_VDD_MPU_OPP12_UV		 985000
#define OMAP4430_VDD_MPU_OPP25_UV		1005000
#define OMAP4430_VDD_MPU_OPP50_UV		1015000
#define OMAP4430_VDD_MPU_OPP100_UV1		1105000
#define OMAP4430_VDD_MPU_OPP100_UV		1195000
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1265000
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1318000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1348000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV2		1390000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV3		1402000


struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP12_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP25_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
=======
#define OMAP4430_VDD_MPU_OPP12_UV		 900000
#define OMAP4430_VDD_MPU_OPP25_UV		 915000
#define OMAP4430_VDD_MPU_OPP50_UV		 945000
#define OMAP4430_VDD_MPU_OPP100_UV1		1055000
#define OMAP4430_VDD_MPU_OPP100_UV		1120000
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1205000
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1278000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1318000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV2		1355000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV3		1403000


struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP12_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
>>>>>>> 2f223424b581331b08fb227605637ae3e2bd7366
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV1, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV2, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV3, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
<<<<<<< HEAD
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1245000
#define OMAP4430_VDD_IVA_OPPTURBO_OV_UV		1295000

struct omap_volt_data omap443x_vdd_iva_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPP50_UV, 13000, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
=======
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1285000
#define OMAP4430_VDD_IVA_OPPTURBO_OV_UV		1355000
...
>>>>>>> 2f223424b581331b08fb227605637ae3e2bd7366
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPPTURBO_UV, 0, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPPTURBO_OV_UV, 0, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
<<<<<<< HEAD
#define OMAP4430_VDD_CORE_OPP100_OV_UV		1195000

struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 38000, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_OV_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
=======
#define OMAP4430_VDD_CORE_OPP100_OV_UV		1295000
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPP12_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP100_UV1, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
=======
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITRO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
>>>>>>> 2f223424b581331b08fb227605637ae3e2bd7366
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV2, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV3, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
};
...
=======
	{.main_vdd_volt = OMAP4430_VDD_IVA_OPPTURBO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
>>>>>>> 2f223424b581331b08fb227605637ae3e2bd7366
        {.main_vdd_volt = OMAP4430_VDD_IVA_OPPTURBO_OV_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
        /* MPU OPP00 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 166000000, OMAP4430_VDD_MPU_OPP12_UV),
        /* MPU OPP0 - OPP50 */
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 300000000, OMAP4430_VDD_MPU_OPP50_UV),
        /* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 500000000, OMAP4430_VDD_MPU_OPP100_UV1),
	/* MPU OPP2 - OPP100 */
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1200000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
        /* MPU OPP6 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1300000000, OMAP4430_VDD_MPU_OPPNITROSB_UV2),
        /* MPU OPP6 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1400000000, OMAP4430_VDD_MPU_OPPNITROSB_UV3),
	/* L3 OPP1 - OPP50 */
	...
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 332000000, OMAP4430_VDD_IVA_OPPTURBO_UV),
        /* IVA OPP4 - OPP-Turbo */
<<<<<<< HEAD
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 466600000, OMAP4430_VDD_IVA_OPPTURBO_OV_UV),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 153600000, OMAP4430_VDD_CORE_OPP50_UV),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 332000000, OMAP4430_VDD_CORE_OPP100_UV),
        /* SGX OPP3 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 433000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
=======
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 466000000, OMAP4430_VDD_IVA_OPPTURBO_OV_UV),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 153600000, OMAP4430_VDD_CORE_OPP50_UV),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 307200000, OMAP4430_VDD_CORE_OPP100_UV),
        /* SGX OPP3 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 484000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
>>>>>>> 2f223424b581331b08fb227605637ae3e2bd7366
	/* FDIF OPP1 - OPP25 */
...
int __init omap4_opp_init(void)
{
	...
	if (omap4_has_mpu_1_2ghz())
                omap4_opp_enable("mpu", 1008000000);
