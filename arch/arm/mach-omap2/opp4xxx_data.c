...
#define OMAP4430_VDD_MPU_OPP100_UV		1045000
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1145000
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1245000
#define OMAP4430_VDD_MPU_OPPNITROSB_OV		1275000
#define OMAP4430_VDD_MPU_OPPNITROSB_OV2		1285000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1348000
#define OMAP4430_VDD_MPU_OPPNITROSB_OV_UV	1355000


struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP25_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP25, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf, 0x0f, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfb, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_OV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfc, 0x2b, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_OV2, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfc, 0x2b, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfc, 0x2b, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_OV_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB_OV, 0xfd, 0x2f, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};

#define OMAP4430_VDD_IVA_OPP50_UV		 962000
#define OMAP4430_VDD_IVA_OPP100_UV		1115000
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1225000
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITRO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_OV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_OV2, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_OV_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-NT */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 100800000, OMAP4430_VDD_MPU_OPPNITRO_UV),
        /* MPU OPP5 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 110000000, OMAP4430_VDD_MPU_OPPNITROSB_OV),
        /* MPU OPP6 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1200000000, OMAP4430_VDD_MPU_OPPNITROSB_OV2),
	/* MPU OPP7 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1300000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),     
	/* MPU OPP8 - OPP-SB2 */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1340000000, OMAP4430_VDD_MPU_OPPNITROSB_OV_UV),     
	/* L3 OPP1 - OPP50 */
	...
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 266100000, OMAP4430_VDD_IVA_OPP100_UV),
        /* IVA OPP3 - OPP-Turbo */
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 500000000, OMAP4430_VDD_IVA_OPPTURBO_UV),
	/* SGX OPP1 - OPP50 */
	...
	OPP_INITIALIZER("aess", "abe_clk", "iva", true, 196608000, OMAP4430_VDD_IVA_OPP100_UV),
        /* ABE OPP3 - OPP100OV */
	OPP_INITIALIZER("aess", "abe_clk", "iva", true, 196608000, OMAP4430_VDD_IVA_OPPTURBO_UV),
};
...
int __init omap4_opp_init(void)
{
	...
	/* Enable Nitro and NitroSB MPU OPPs */   
		...
		omap4_opp_enable("mpu", 1300000000);
                omap4_opp_enable("mpu", 1340000000);
